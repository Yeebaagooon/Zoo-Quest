...
rmsFunc = ''
rmsMain = 'main.c'
files = ['zshared.c', 'voids.c', 'globals.c', 'intsstrings.c', 'databases.c', 'ysearch.c', 'gamefunctions.c', 'choice.c', 'nottud.c', 'text.c', 'setup.c', 'techstat.c',
 'tutorialdeer.c', 'ActDeer.c', 'scorescreen.c', 'tutorialrhino.c', 'actrhino.c']
