...
code("if(level == 2){");
code("trQuestVarSet(\"temp\", 3);");
code("}");
code("if(level == 3){");
code("trQuestVarSet(\"temp\", 4);");
code("}");
code("if(level == 4){");
code("trQuestVarSet(\"temp\", 5);");
code("}");
...
code("trOverlayText(\"Uber Poachers Spawning... run!\", 5.0,-1,-1,600);");
code("playSound(\"\cinematics\04_in\armyarrive.wav\");");
code("}");
code("}");
code("}");
...
code("modifyProtounitAbsolute(\"Slinger\", cNumberNonGaiaPlayers, 0, 5);");
